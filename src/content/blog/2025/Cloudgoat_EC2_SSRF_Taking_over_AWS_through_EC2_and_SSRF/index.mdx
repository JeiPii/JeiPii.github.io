...
## Pacu Walkthrough
start up Pacu and you hacked AWS already... Ofcourse I'm only joking but it does feel like that once you run a couple the modules. 
I'm very impressed with the results that it gives.
